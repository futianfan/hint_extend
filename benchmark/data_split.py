...
def select_and_split_data(input_file, filter_func, output_file_name, split_year=2014):
	...
	fieldname = ['nctid', 'status', 'why_stop', 'label', 'phase', 
				 'diseases', 'icdcodes', 'drugs', 'smiless', 'criteria', 'additional_feature']
...
def clean_data(input_file, clean_file):
	...
	rows = csvfile2rows(input_file)
	newrows = []
	fieldname = ['nctid','status','why_stop','label','phase','diseases','icdcodes','drugs','smiless','criteria', 'additional_feature']
...
if __name__ == "__main__":
	input_file = 'data/raw_data_new.csv'
	clean_file = "data/clean_data_new.csv"
